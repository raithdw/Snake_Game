...
public class Board extends JPanel implements ActionListener {
    ...
    private void loadImages() {
        ...
        ImageIcon imageid1 = new ImageIcon("src/images/body.png");
        ball = imageid1.getImage();

        ImageIcon imageid2 = new ImageIcon("src/images/food.png");
        apple = imageid2.getImage();

        ImageIcon imageid3 = new ImageIcon("src/images/head.png");
